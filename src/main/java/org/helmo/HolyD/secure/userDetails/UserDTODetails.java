...
public class UserDTODetails extends UserDTO implements UserDetails  {
    ...
    public UserDTODetails(UserDTO userDTO) {
        super(userDTO.getId(), userDTO.getRole(), userDTO.getNom(), userDTO.getPrenom(), userDTO.getEmail(), userDTO.getPasswd(), userDTO.getTokenConnection(), userDTO.getVacances());
    }
